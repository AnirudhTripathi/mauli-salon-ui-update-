...
export const BackGround = styled.div`
  // landing-image: url(${landingpage1});
  // landing-image: url(${landingpage2});
  // landing-size: ${landingpage1})
...
export const Layer = styled.div`
  width: 100%;
  height: 0;
  background: linear-gradient(rgba(216, 192, 192, 0.6), var(--secondary-color));
  border-radius: 10px;
  position: absolute;
  left: 0;
  bottom: 0;
